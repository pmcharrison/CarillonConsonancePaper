Note: this repository only contains a subset of the recordings from the
(Westertoren) Carillon Bell Tower Sample Library.
For the full set see https://archive.org/details/PeabodyEssexMuseum-WesterkerkCarillonSampleLibrary.
